...
export const WatchlistLoginDialog = ({ open, onOpenChange }: WatchlistLoginDialogProps) => {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="w-full h-full max-w-none max-h-none p-0 gap-0 border-0 bg-transparent [&>button]:hidden z-[100]">
        <div className="fixed inset-0 flex justify-center items-center bg-black z-[100]">
                ...
                <div className="bg-gradient-to-br from-gray-900 via-gray-800 to-black w-full h-full flex flex-col items-center justify-center text-center space-y-6 p-8">
                  ...
                  >
                    <div className="flex items-center justify-center gap-2 text-white">
                      <p className="text-sm font-medium">Unlock personalized recommendations!</p>
                    </div>
