  ...
  return (
    <TooltipProvider>
      <Card className="group overflow-hidden transition-all duration-300 hover:shadow-lg">
        <div className="aspect-[2/3] overflow-hidden relative cursor-pointer" onClick={handleMoreInfo}>
          <img
            {...imageProps}
            alt={title}
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <div className="flex items-center gap-1 text-foreground cursor-help">
                  ...
                  <span className="font-bold text-sm">{imdbRating ? imdbRating.toFixed(1) : rating.toFixed(1)}</span>
                </div>
              </TooltipTrigger>
              <TooltipContent>
