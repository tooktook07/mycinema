            ...
            <div className="p-2 sm:p-6">
              <div className="flex gap-2 sm:gap-4 mb-2 sm:mb-4">
                ...
                {imageProps && (
                  <div className="w-20 sm:w-32 flex-shrink-0">
                    <img {...imageProps} alt={movie.title} className="w-full rounded shadow-lg" />
                  </div>
                )}
                ...
                <div className="flex-1 min-w-0">
                  ...
                  {movie.tagline && (
                    <p className="text-[10px] sm:text-sm text-muted-foreground italic line-clamp-2 mb-1.5">
                      "{movie.tagline}"
                    </p>
                  )}
                  ...
                  <div className="flex flex-wrap gap-0.5 sm:gap-1.5 mb-1.5 sm:mb-3">
                    <Link to={getYearUrl(movie.year)}>
                      <Badge
                        variant="secondary"
                        className="text-[9px] sm:text-xs px-1 py-0 sm:px-2 sm:py-0.5 h-4 sm:h-auto hover:bg-primary hover:text-primary-foreground cursor-pointer transition-colors"
                      >
                    ...
                    {movie.runtime && (
                      <Badge
                        variant="secondary"
                        className="text-[9px] sm:text-xs px-1 py-0 sm:px-2 sm:py-0.5 h-4 sm:h-auto"
                      >
                      ...
                      <div className="flex gap-0.5 sm:gap-2 flex-1">
                        <Tooltip>
                          <TooltipTrigger asChild>
                            ...
                            >
                              <ThumbsDown
                                className={`h-2.5 w-2.5 sm:h-4 sm:w-4 sm:mr-2 ${currentRating === 1 ? "fill-current" : ""}`}
                              />
                        ...
                        <Tooltip>
                          <TooltipTrigger asChild>
                            ...
                            >
                              <ThumbsUp
                                className={`h-2.5 w-2.5 sm:h-4 sm:w-4 sm:mr-2 ${currentRating === 5 ? "fill-current" : ""}`}
                              />
                        ...
                        <Tooltip>
                          <TooltipTrigger asChild>
                            ...
                            >
                              <Heart
                                className={`h-2.5 w-2.5 sm:h-4 sm:w-4 sm:mr-2 ${currentRating === 10 ? "fill-current" : ""}`}
                              />
              ...
              <Tabs defaultValue="details" className="w-full">
                <TabsList className="w-full grid grid-cols-3 mb-2 sm:mb-4 h-7 sm:h-10">
                  <TabsTrigger value="details" className="text-[9px] sm:text-sm px-1 sm:px-4">
                    Details
                  </TabsTrigger>
                  <TabsTrigger value="cast" className="text-[9px] sm:text-sm px-1 sm:px-4">
                    Cast
                  </TabsTrigger>
                  <TabsTrigger value="more" className="text-[9px] sm:text-sm px-1 sm:px-4">
                    More
                  </TabsTrigger>
                </TabsList>
                ...
                <TabsContent value="details" className="space-y-1.5 sm:space-y-3">
                  ...
                  {movie.genres && movie.genres.length > 0 && (
                    <Card className="p-1.5 sm:p-3">
                      <h4 className="text-[9px] sm:text-xs font-semibold mb-1 sm:mb-2 text-muted-foreground uppercase tracking-wide">
                        Genres
                      </h4>
                      <div className="flex flex-wrap gap-0.5">
                        {movie.genres.map((g) => (
                          <Link key={g} to={getGenreUrl(g)}>
                            <Badge variant="secondary" className="text-[9px] sm:text-xs px-1 py-0 h-4 sm:h-auto hover:bg-primary hover:text-primary-foreground cursor-pointer transition-colors">
                              {g}
                            </Badge>
                          </Link>
                        ))}
                    ...
                    <div className="flex flex-wrap gap-1 sm:gap-2">
                      {hasValidImdbId && (
                        <Button
                          ...
                          size="sm"
                          asChild
                          className="flex-1 sm:flex-none h-7 sm:h-9 text-[10px] sm:text-sm px-1.5 sm:px-3"
                        >
                      ...
                      <div className="flex flex-wrap gap-0.5">
                        {movie.director.split(",").map((d) => (
                          <Link key={d.trim()} to={getPersonUrl(d.trim())}>
                            <Badge
                              variant="secondary"
                              className="text-[9px] sm:text-xs px-1 py-0 h-4 sm:h-auto hover:bg-primary hover:text-primary-foreground cursor-pointer transition-colors"
                            >
                              {d.trim()}
                            </Badge>
                          </Link>
                        ...
                        {movie.sound
                          ...
                          .map((person) => (
                            <Badge
                              key={person.trim()}
                              variant="outline"
                              className="text-[8px] sm:text-xs px-1 py-0 h-4 sm:h-5"
                            >
                              {person.trim()}
                            </Badge>
                          ))}
